...
class PickerPage(QWidget):
    ...
    # spec/63 §4 LOCKED keymap: F10 opens the viewport's inspection lens
    # (modal, honest peaking + true 1:1 + AF). When this shell is reconciled
    # in spec/70 Phase 3 it'll embed PhotoViewport and inherit F10 directly;
    # the old `full_resolution_requested` signal + Surface 10 page were
    # retired (spec/65 §3.10) — the lens supersedes them.
